...
THEME_ALIASES: Dict[str, str] = {
    # Conflict cluster
    "military": "conflict", "violence": "conflict", "tension": "conflict",
    "crisis": "conflict", "warfare": "war", "fighting": "war",
    # Peace cluster
    "diplomacy": "peace", "treaty": "peace", "ceasefire": "peace",
    "reconciliation": "peace",
    # Politics cluster
    "government": "politics", "election": "politics", "policy": "politics",
    "legislation": "politics", "democracy": "politics",
    # Technology cluster
    "tech": "technology", "digital": "technology", "innovation": "technology",
    "computing": "technology", "artificial intelligence": "AI",
    "machine learning": "AI",
    # Science cluster
    "research": "science", "discovery": "science", "breakthrough": "science",
    "astronomy": "space", "nasa": "space",
    # Environment cluster
    "weather": "climate", "pollution": "environment",
    "sustainability": "environment", "green": "environment",
    "earthquake": "disaster", "flood": "disaster", "hurricane": "disaster",
    "wildfire": "disaster",
    # Economy cluster
    "business": "economy", "trade": "economy", "inflation": "finance",
    "stocks": "markets", "investment": "finance",
    # Health cluster
    "medicine": "health", "healthcare": "health", "pandemic": "disease",
    "virus": "disease", "vaccine": "health",
    # Social cluster
    "refugee": "humanitarian", "aid": "humanitarian", "charity": "humanitarian",
    "poverty": "humanitarian", "local": "community", "neighborhood": "community",
}
...
def blend_textures(
    ...
    all_timbre, all_movement, all_harmonic = [], [], []
    resolved_themes = []
    ...
    return TextureBlend(
        timbre_words=unique_shuffle(all_timbre, rng)[:max_words],
        movement_words=unique_shuffle(all_movement, rng)[:max_words],
        harmonic_words=unique_shuffle(all_harmonic, rng)[:1],
...
class DailyVariation:
    ...
    instrument_rotation: int
    mood_shuffle_seed: int
    texture_emphasis: str
    tempo_nudge: int
